...
- **LIBER** members have created the [Digital Scholarship & Data Science Essentials for Library Professionals](https://libereurope.github.io/ds-essentials/), which this guide is a part of. Guidance also includes [data visualisation](dataviz.qmd) and [data as collections](collectionsasdata.qmd), and continues to grow.
