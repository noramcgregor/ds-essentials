...
<div class="card text-white bg-primary mb-3" style="max-width: 20rem;">
  ...
  <div class="card-body">We have a DS Topic Guide for that! Try [Getting Started in DS](gettingstarted.qmd).</div>
</div>
...
Don't know where to begin? Visit [Getting Started in DS](gettingstarted.qmd){.btn .btn-outline-primary .btn role="button"} 
