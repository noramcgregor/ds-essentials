...
Written by [LIBER](https://libereurope.eu/) professionals working in research libraries across Europe, the aim of each guide is to provide a gentle and concise introduction to practical applications of digital scholarship and data science to the work of libraries today, and share personal recommendations for useful tutorials, recommended reading, and communities of practice to help colleagues on their learning journey.  
	...
	<div class="container">
	  <div class="row row-cols-auto">
	    <div class="col"><div class="card text-white bg-primary mb-3" style="max-width: 20rem;">
	  ...
	  <div class="card-body">
	    ...
	    <div class="col"><div class="card text-white bg-secondary mb-3" style="max-width: 20rem;">
	  <div class="card-header">Secondary Header</div>
	  <div class="card-body">
	    <h2 class="card-title">Secondary card title</h2>
	    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
	  </div>
	</div>
	</div>
	    <div class="col"><div class="card text-white bg-success mb-3" style="max-width: 20rem;">
	  <div class="card-header">Success Header</div>
	  <div class="card-body">
	    <h2 class="card-title">Success card title</h2>
	    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
	  </div>
	</div>
	</div>
