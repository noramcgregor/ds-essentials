...
![A diagram showing a convolutional neural network for image classification, progressing from input image to feature learning, flattening, classification, and output probabilities.](images/c-v_CNN_architecture.png)
