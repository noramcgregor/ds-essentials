...
- [ ] "Topic Guides" is always referred to as "DS Topic Guides" and should be bolded
- [ ] Headings correctly formatted: The title of each guide is already in h1# so main section headers such as "Introduction" should be second-level header with h2 tag ##.
- [ ] Capitalise the first, last and ‘important’ words of every heading; for example, ‘Snow White and the Seven Dwarves’.
- [ ] Key words and jargon should be in bold
...
- [ ] Images have alt-tags and captions

Accessibility 
- [ ] Replace [Latin abbreviation](https://book.the-turing-way.org/community-handbook/style#avoid-latin-abbreviation) (eg., ex., etc.,) with full text
