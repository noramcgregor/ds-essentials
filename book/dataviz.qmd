...
![Map of cultural heritage item locations around Exeter](images/dataviz_exetermap.png){fig-alt="A street map of Exeter in England with coloured dots showing locations of hundreds of cultural heritage buildings and artifacts as coloured dots"}
...
![The importance of colour in recognising categories](images/dataviz_color_palettes.png){fig-alt="Two scatter plots, each with two categories of data. All points are blue in the left plot, one category has round points and the other has triangles. They are hard to distinguish. The categories are also round and triangles in the right plot, but the triangles are now orange. They are easy to distinguish."}
