...
To understand the importance of supporting the development of the digital skills in our sector, one only needs to look at any of the _Digital Scholarship & Data Science Topic Guides for Library Professionals_, all of which contain a plethora of useful real-life applications of new technologies being put into action in libraries. The [Getting Started in Libraries Topic Guide](gettingstarted.qmd.qmd) also points to Digital Scholarship & Data Science Skills Competency Frameworks which underscore the urgent need for upskilling.   

But what are the benefits in particular of establishing a local programme for staff in your institution/community?  {TODO:}
...
In some cases you may need buy-in from managers to allow staff time and space to dedicate to learning these new skills. It can be difficult to convince managers sometimes of the value of learning skills now which may take some years to truly embed or come to practical fruition. Spending time building ones "awareness" of the landscape is not always deemed a strong enough basis for approving time away from more immediate tangible deliverables, but awareness is the first step on the learning ladder and is essential for transformation. This resource, Digital Scholarship & Data Science Topic Guides, contains loads of evidence to share with your management for why investing in digital scholarship and data science staff skills and awareness is key to sustainable digital transformation over time. Have a look at the [Getting Started in DS Topic Guide](gettingstarted.qmd), particularly the section on [Relevance to the Library Sector](gettingstarted.qmd#relevance-to-the-library-sector-case-studiesuse-cases) for the latest supporting reports and competency & skills frameworks on this.

We also laid out some specific objectives to make clear to ourselves and colleagues what we ultimately hoped to achieve with the training programme:
...
Each Topic Guide has a **Recommended Reading/Viewing** section and you can also find some good starting points under [Recommended Reading Lists](references.qmd).
