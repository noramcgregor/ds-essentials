...
[LIBER's Open Science Roadmap](https://zenodo.org/records/1303002) produced by the [LIBER Open Access Working Group](https://libereurope.eu/working-group/open-access-working-group/) is an exceptional resource and outlines the "specific actions libraries can take to champion Open Science, both within and beyond their own institutions". It provides specific recommendations on how libraries can (and *must*) work across all of these areas to fully advocate, raise awareness of and support Open Science:
...
These can be a good source of inspiration and examples to help your institution practically adopt open research.

LIBER’s [Research Data Management Working Group](https://libereurope.eu/working-group/research-data-management/) produced a helpful factsheet, [Implementing FAIR Data Principles: The Role of Libraries](https://libereurope.eu/article/implementing-fair-data-principles-role-libraries/), specifically to help libraries which do not already actively promote and include the FAIR Data Principles in their work. Their advice includes: 
...
**2. _Providing advice and training to support researchers_**
...
**3. _Finding innovative solutions to help your institution embrace open research publishing practices_**
...
Library staff can also help their institutions to recognise, showcase, and reward high impact data sets which have been shared openly and reused by other researchers. Colleagues who work with [bibliometrics/citation analysis](https://pdoehle.github.io/bibliometrics-for-librarians/about/) can help develop their institution’s understanding of the impact of their research and shared data, especially if more outputs across the research lifecycle are being openly published. This activity can encourage open research practices and help institutions incentivise open practices.


**4. _Directly managing or supporting an open research repository/infrastructure_**
