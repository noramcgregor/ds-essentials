...
*	**Facsimile, surrogate, object or edition?** Opinions often vary on how/what we consider digitised objects to be and what we call them. You may have come across the terms “digital surrogate”, “digital facsimile” or “digital edition” for example. But regardless of what we call them, it is now widely considered that the outputs of digitisation, whilst inherently connected to the analogue original, ontologically constitute a new thing in themselves. It’s therefore important to be aware that digitisation processes remove or reduce some aspects but can add or increase others.
